...
@section('title', 'Edit Transaction | Elmullim')
                        ...
                        <div class="card-body">
                            <form action="{{ route('transactions.update', $transaction) }}" method="POST"
                                            ...
                                            <select class="form-control" id="teacher_id" name="teacher_id" required>
                                                ...
                                                @foreach ($teachers as $teacher)
                                                    <option value="{{ $teacher->id }}"
                                                        {{ (old('teacher_id') ?? $transaction->teacher_id) == $teacher->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="total" name="total"
                                                    value="{{ old('total') ?? $transaction->total }}" step="0.01"
                                                    min="0" required>
                                            </div>
                                            @error('total')
                                                <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="commission">Commission Percentage <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="commission" name="commission"
                                                    value="{{ old('commission') ?? $transaction->commission }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="commission_amount"
                                                    ...
                                                    value="{{ old('commission_amount') ?? $transaction->commission_amount }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="teacher_amount">Teacher Amount <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="number" class="form-control" id="teacher_amount"
                                                    name="teacher_amount"
                                                    value="{{ old('teacher_amount') ?? $transaction->teacher_amount }}"
                                                    step="0.01" min="0" readonly>
                                            </div>
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="fw-bold text-warning" id="summary-commission">$0.00
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-2">
                                                        <div class="col-6">
                                                            ...
                                                            <div class="fw-bold text-success" id="summary-teacher">$0.00
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                ...
                                                <div class="card-body p-3">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fw-bold">
                                                                {{ $transaction->created_at->format('Y-m-d H:i A') }}</div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <small class="text-muted">Last Updated:</small>
                                                            <div class="fw-bold">
                                                                {{ $transaction->updated_at->format('Y-m-d H:i A') }}</div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row mt-2">
                                                            <div class="col-12">
                                                                <small class="text-warning">
                                                                    ...
                                                                    This transaction has been modified since creation.
                                                                </small>
                                                            </div>
                                                        </div>
                                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('transactions.show', $transaction) }}" class="btn btn-info ms-2">
