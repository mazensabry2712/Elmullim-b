...
@section('title', 'Edit Coupon | Elmullim')
                    ...
                    <div class="card-header" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; border: none;">
                        <div class="d-flex align-items-center">
                            <div class="card-icon me-3">
                                <i class="fas fa-edit fa-2x" style="color: rgba(255,255,255,0.9);"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h4 class="card-title mb-0 text-white fw-bold">Edit Coupon</h4>
                                <p class="card-category mb-0" style="color: rgba(255,255,255,0.8); font-size: 14px;">
                                    Modify coupon: <strong>{{ $coupon->code }}</strong>
                                </p>
                            </div>
                            ...
                            <a href="{{ route('coupons.show', $coupon->id) }}" class="btn btn-outline-light btn-round shadow-sm">
                                ...
                                <div class="alert alert-info border-0 shadow-sm">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <span class="text-muted">{{ $coupon->created_at->format('M d, Y') }}</span>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <span class="badge badge-primary">{{ $coupon->students()->count() ?? 0 }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('coupons.update', $coupon->id) }}" method="POST" id="couponForm">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number"
                                                           ...
                                                           id="max_recipients"
                                                           name="max_recipients"
                                                           value="{{ old('max_recipients', $coupon->max_recipients) }}"
                                                           min="1"
                                                           required>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch mb-3">
                                                        <input class="form-check-input"
                                                               ...
                                                               name="restricted"
                                                               value="1"
                                                               {{ old('restricted', $coupon->restricted) ? 'checked' : '' }}>
                            ...
                            <div class="card border-0">
                                <div class="card-body text-center">
                                    ...
                                    <a href="{{ route('coupons.show', $coupon->id) }}" class="btn btn-info btn-lg me-3 shadow">
