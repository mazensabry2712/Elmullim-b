...
@section('title', 'Edit Question | Elmullim')
                        ...
                        <form action="{{ route('questions.update', $question) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">Question Information</div>
                                        </div>
                                        <div class="card-body">
                                            <div class="quiz-info-card">
                                                <h6 class="text-success mb-3">
                                                    <i class="fa fa-question-circle"></i> Current Question Details
                                                </h6>
                                                ...
                                                <div class="quiz-detail">
                                                    ...
                                                    <span class="text-muted">
                                                        ...
                                                        {{ $question->updated_at->format('M d, Y h:i A') }}
                                                    </span>
                                                </div>
                                                @if($question->quiz)
                                                <div class="quiz-detail">
                                                    <strong>Current Quiz:</strong>
                            ...
                            <div class="card-action">
                                ...
                                <a href="{{ route('questions.show', $question) }}" class="btn btn-info">
                                    <i class="fa fa-eye"></i> View Question
                                </a>
...
$(document).ready(function() {
    ...
    // Trigger change event on page load to show current quiz info
