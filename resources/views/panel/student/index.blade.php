...
@section('title', 'Students | Elmullim')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="text-truncate"
                                                        ...
                                                        {{ Str::limit($student->description, 50) ?? 'N/A' }}
                                                    </span>
                                                </td>
                                                <td>
                                                    @if ($student->educationLevel)
                                                        <span
                                                            class="badge bg-info">{{ $student->educationLevel->name }}</span>
                                                    @else
                                                ...
                                                <td>
                                                    @if ($student->gender)
                                                        <span
                                                            class="badge {{ $student->gender == 'male' ? 'bg-primary' : 'bg-success' }}">
                                                            {{ ($student->gender) }}
                                                        </span>
                                                    @else
                                                        <span class="text-muted">Not Set</span>
