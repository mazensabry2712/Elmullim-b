...
@section('title', 'Edit Content | Elmullim')
...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Edit Content</h3>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Edit Content: {{ $record->title }}</h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('contents.update', $record->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-action">
                                ...
                                <a href="{{ route('contents.show', $record->id) }}" class="btn btn-info">
                                    <i class="fa fa-eye"></i>
                                    View Content
                                </a>
...
<script>
    $(document).ready(function() {
        ...
        // Remove beforeunload event when form is submitted
